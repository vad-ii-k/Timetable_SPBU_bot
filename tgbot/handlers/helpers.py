...
async def create_message_based_on_content(message: Message, text: str, is_photo: bool) -> Message:
    if is_photo:
        answer_msg = await message.answer_photo(photo=InputFile("data/converter/output.png"), caption=text)
