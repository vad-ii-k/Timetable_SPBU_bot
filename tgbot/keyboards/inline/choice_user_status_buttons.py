    ...
    inline_keyboard=[
        [
            InlineKeyboardButton(
                ...
                callback_data=user_status_callback.new(name="student group"),
            )
        ],
        [
            InlineKeyboardButton(
                text="Навигации по программам",
                callback_data=user_status_callback.new(name="student navigation"),
            )
        ],
        [
            InlineKeyboardButton(
                text="ФИО преподавателя",
                callback_data=user_status_callback.new(name="teacher"),
            )
        ],
    ]
)
