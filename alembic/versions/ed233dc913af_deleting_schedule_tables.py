...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['teacher_spbu_id'], ['teacher_spbu.teacher_spbu_id'], name='teacher_user_teacher_spbu_id_fkey'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['teacher_id'], ['teacher_spbu.teacher_spbu_id'], name='teacher_study_event_teacher_id_fkey'),
